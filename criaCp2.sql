...
ALTER TABLE t_rhstu_bairro
    ADD CONSTRAINT uk_rhstu_bairro_zona CHECK ( nm_zona_bairro IN (
        'CENTRO',
        'ZONA LESTE',
        'ZONA NORTE',
        'ZONA OESTE',
...
--
-- Verifica se existe alguma trigger criada
--
select * from user_triggers where table_name like 'T_RHSTU%'
